<%@ page import="com.huang.biz.impl.TblcourseDaoImpl" %>
<%@ page import="java.util.List" %>
<%@ page import="com.huang.entity.Tblcourse" %>
<%--
...
<div id="sidebar">
  ...
  <ul>
    ...
    <li><a href="teacher.jsp"><i class="icon icon-th"></i> <span>教员信息管理</span></a></li>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <%
                TblcourseDaoImpl cou=new TblcourseDaoImpl();
                List<Tblcourse> list=cou.findAll();
              ...
              <tr class="gradeU">
                ...
                <td style="text-align: center"><%=c.getTeaId()%></td>
