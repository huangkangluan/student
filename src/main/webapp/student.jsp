...
<head>
  ...
  <script>
    function delete_stu(stuid){
          var d=window.confirm("您确定要删除吗？");
          if(d==true){
            location="form/delete_student.jsp?stuid="+stuid;
          }
    }
  </script>
</head>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tr class="gradeU">
                ...
                <td><div align="center"><a href="update_student.jsp?stuid=<%=s.getStuId()%>">编辑</a></div></td>
                <td class="center"><div align="center"><a href="javascript:delete_stu(<%=s.getStuId()%>)">删除</a></div></td>
              </tr>
              </tbody>
              <%}%>
            </table>
